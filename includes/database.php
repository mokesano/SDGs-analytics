...
class Database {
     ...
     */
    public static function saveResearcher(string $orcid, string $name, array $institutions = [], int $totalWorks = 0): ?int {
        try {
            $db = self::getInstance();
            $stmt = $db->prepare("
     ...
     */
    public static function saveWorkSdg(int $workId, string $sdgCode, float $confidenceScore, 
                                       string $contributorType, float $keywordScore = 0,
                                       float $similarityScore = 0, float $causalScore = 0,
                                       float $impactScore = 0): ?int {
        try {
            $db = self::getInstance();
            $stmt = $db->prepare("
